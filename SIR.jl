...
# ╔═╡ e5ef12c3-193c-4988-a02c-7e64ebdc0855
using PlutoUI

# ╔═╡ 6c60fac8-4448-4043-9398-846001659417
begin
	using DynamicalSystems, Plots, IJulia
	function SIRModel!(dx,x, p,t)
		β, γ = p
		S, I, R = x
   dx[1] = -β*x[1]*x[2]
    dx[2] = β*x[1]*x[2]-γ*x[2] 
    dx[3] =  γ*x[2]
	    end 
	
end

# ╔═╡ c436b334-b837-11ef-3c40-039a304564b9
 md" # SIR models in epidemiology"

# ╔═╡ 4cad62c8-8c91-456c-a3aa-291f0ee495f6
md""" The SIR model is one of the simplest compartmental models, and many models are derivatives of this basic form. The model consists of three compartments:"
...
γ  is the average number of person removed per time.
...
# ╔═╡ 00fca7d6-cb66-4b05-9683-df9fe70d44e9
begin
	p = [0.1,0.05]
	init = [0.99,0.01,0.0]
end

# ╔═╡ e5f5c609-a936-4032-b645-51d1c4399c7f
lsl = ContinuousDynamicalSystem(SIRModel!,init,p)

# ╔═╡ a857f379-f94d-4086-ab5d-2d4e9485725e
# ╠═╡ disabled = true
#=╠═╡
sir_sol = solve(sir_prob,saveat = 0.01)
  ╠═╡ =#

# ╔═╡ 547ae213-ae08-4223-9cd8-e7a904daf468
tr, T = trajectory(lsl, 300.0)	

# ╔═╡ 52cc0e23-5b55-4327-b13a-94cad31641a4
begin
	plot((tr[:,1]))
	plot!((tr[:,2]))
	plot!((tr[:,3]))
...
manifest_format = "2.0"
project_hash = "bbd9fe25cb7ce6a5b00e3d34771d550fcf8661cc"
...
git-tree-sha1 = "5f895c45ea6214eab1df0628eeaaea30c0217927"
...
git-tree-sha1 = "cb91ecbfa357588171d717f5bb1ec0c6176af49c"
...
git-tree-sha1 = "dfa4921d26bfea37885aaa1c08513471a4f5a190"
...
git-tree-sha1 = "cd313cc7235d89a65e2c5d42ca54d24316479a1f"
...
git-tree-sha1 = "a211f904a9b6cb47feecb83e4e5780eff398c88a"
...
git-tree-sha1 = "18cfd00df3cbbebf8ea4ec7ea6bbceb3af716bd0"

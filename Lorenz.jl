...
# ╔═╡ dcf7f9d9-923c-4446-b4ec-c5f1e21bf2e4
using PlutoUI, Plots, LaTeXStrings, PlutoTeachingTools, DifferentialEquations, Measures, DynamicalSystems

# ╔═╡ a379e190-b92f-11ef-2b35-e198da2980c4
begin
	PlutoUI.TableOfContents(title = "Contents")
end

# ╔═╡ 1d66eeea-336c-4771-b23c-e19acb18b00f
md"""
# Lorenz Attractor
"""

# ╔═╡ 211d08a7-dffc-4bb8-9702-f9495798e838
md"""
...
# ╔═╡ e70a1a9f-cf2e-4160-8f5a-7e661c69a50f
begin
...
# ╔═╡ 9298c9db-544e-45db-9860-de8401cbd4e2
begin
# Initial conditions and parameters
u0 = [1.0, 1.0, 1.0]  # Initial values for x, y, z
p = (10.0, 28.0, 8.0 / 3.0)  # σ, ρ, β
...
# ╔═╡ fac5c244-eca4-48c0-b627-63dd03353f41
begin
# Plot the Lorenz attractor
Phase = plot(sol[1, :], sol[2, :], sol[3, :], 
		title="Lorenz Attractor",  legend=false,
...
#try the backends plotly() and gr()

# ╔═╡ 782e34be-5e01-45b8-b3e4-ab77c968837d
plotly()

# ╔═╡ dbf8ef76-e626-4c4e-97ee-311dce8e7b7b
gr()

...
# ╔═╡ 9860fc90-b906-11ef-39d2-79f2b5ec25c1
using PlutoUI, Plots, LaTeXStrings, PlutoTeachingTools, DifferentialEquations, Measures, DynamicalSystems

# ╔═╡ dc42bea8-714c-4ae6-916a-100e991973cb
begin
	PlutoUI.TableOfContents(title = "Contents")
end

# ╔═╡ 78cd009d-47cc-4af9-b3cc-f10c2502f673
md"""
# FitzHugh–Nagumo model
"""

# ╔═╡ f811b502-a285-4377-8352-a9884a9c2e33
md"""
## Mathematical model"""

# ╔═╡ f115b080-cefe-48e4-b115-d913c92de021

md""" 

- The FitzHugh-Nagumo (FHN) neuron model is one of the most useful for studying how neuronal excitability changes over time because it is easy to understand and can show important behaviors like spiking and resting states.\

- Completely synchronized and short-time synchronized neurons may exhibit pathological states, such as epileptic seizures.\

- To avoid these kinds of problems or keep the brain active, it is important to understand how the dynamics of networks of neurons change over time and in different conditions. """

# ╔═╡ fe099c7d-a1a3-4c8d-a8dc-ac6ac8d3917f
md"""
The equations for this **dynamical system**

```math
\frac{dv}{dt} = v - \frac{v^{3}}{3} - w - R I_{ext}
```
```math
...
# ╔═╡ 215b4954-c04c-43e6-a63b-8498d3eb52f9
begin
...
# ╔═╡ da802435-355a-4349-9c96-fc38b351da6a
begin
# Initial conditions and parameters
u0 = [0.0, 0.0]  # Initial values for u and v
p = (0.5, 0.08, 0.7, 0.8)  # I, ε, a, b
...
# ╔═╡ 11c6e404-5bde-4e68-bf9e-508e7d679ad7
begin
Timeseries = plot(sol.t, sol[1, :], 
			 label="v", title="FitzHugh-Nagumo Time Series",
			 framestyle=:box, grid=:false,
			 lw=:2, lc=:red, 
        	 xlabel=L"Time(t)", xlim=(0, 500),
        	 ylabel=L"v", 
        	 ...
        	 margin=5mm, dpi=500)
			 plot!(sol.t, sol[2, :], 
			 label="w", title="FitzHugh-Nagumo Time Series",
			 framestyle=:box, grid=:false,
			 lw=:2, lc=:blue, 
        	 xlabel=L"Time(t)", xlim=(0, 500),
        	 ylabel=L"w", 
			 ...
			 legendfont=font(8, "Computer Modern"),
        	 margin=5mm, dpi=500)
			 plot!(legend=:outertop, legendcolumn=:2)
	Phase_space = plot(sol[1, :], sol[2, :], 
			 title="Phase space",label= "v vs w",
			 framestyle=:box, grid=:false,
			 lw=:2, lc=:green, 
        	 xlabel=L"v", 
        	 ylabel=L"w", 
			 ...
			 legendfont=font(8, "Computer Modern"),
        	 margin=5mm, dpi=500)
	plot!(legend=:outertop, legendcolumn=:1)
	both=plot(Timeseries, Phase_space, layout=(1, 2), size=(1000, 500))
end
...
manifest_format = "2.0"
project_hash = "466063f52a1705efb55024cb5850d37c735cc162"
...
git-tree-sha1 = "643b83e211dfb6790b2e85785e75969ea7ac8743"
...
git-tree-sha1 = "e5235a09ab602ac2d394dd3b3d9cb7789e255887"
...
git-tree-sha1 = "d7ce51fbfa5ccb9c38ab215456e872bba09ce8da"
...
git-tree-sha1 = "1805e06e5e0b1ab18f8b1f3262cf83aa60a1e5e4"
...
git-tree-sha1 = "4654a6d9fa5df574deb2840ac904d57af701d26e"
...
git-tree-sha1 = "acd76c11deea8db29664a4bf0f24e58d41da78c5"
